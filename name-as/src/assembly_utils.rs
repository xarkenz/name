...
use crate::assembly_helpers::{parse_register_to_u32, translate_identifier_to_address};
...
pub fn assemble_i_type(opcode: u32, rs: Option<String>, rt: Option<String>, immediate: Option<i32>) -> Result<u32, String> {
...
pub fn assign_i_type_arguments(arguments: &Vec<LineComponent>, args_to_use: &[ArgumentType], symbol_table: &Vec<Symbol>, current_address: &u32) -> Result< (Option<String>, Option<String>, Option<i32>), String > {
    let mut rs: Option<String> = None;
    let mut rt: Option<String> = None;
...
pub fn assign_j_type_arguments(arguments: &Vec<LineComponent>, args_to_use: &[ArgumentType]) -> Result<String, String> {
